...
public class Main {
    ...
    public static void printGitStatus(String dir) {
        ...
        processBuilder.command("bash", "-c", "git branch --show-current && git show -s --format=%ct && git log -1 | grep Author && git diff");
        ...
        try {
            ...
            if (exitVal == 0) {
                ...
                System.out.println("local changes: " + (output.toString().indexOf("no change") > -1));
